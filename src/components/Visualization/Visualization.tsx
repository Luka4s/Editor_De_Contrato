      ...
      <aside className={styles.boxView} id="content1">
        <div id="page-break">
          ...
          <p className={styles.view}>
            ...
            09560340, Brasil, neste ato representada na forma de sua
            constituição social, doravante denominada simplesmente de{" "}
          ...
          <p className={styles.view}>
            ...
            sociais, ora denomidadas Contratante e Contratada, ajustam entre si,
            a prestação de serviços de manutenção de microcomputadores e
          ...
          <p className={styles.view}>
            ...
            monitoramento de dispositivos, consultoria para projetos
