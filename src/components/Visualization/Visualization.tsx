        ...
        <div id="content1">
            ...
            <div id="content2">
                ...
                <div className={styles.view}>
                  <ul>
                    <li>
                      Gestão e monitoramento dos dispositivos e usuários conforme tabela
                      de Escopo de Serviços;
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      local. Caso necessário, esses itens não inclusos serão cobrados de
                      maneira avulsa;
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      estabelecendo uma relação de parceria para proporcioar ao cliente
                      maior segurança e estabilidade nos seus processos;{" "}
                    </li>
                    <li>
                      Consultoria operacional de gestão de tecnologia da informação para
                      novos projetos e/ou aquisição de novos hardwares e softwares;
                    </li>
                    <li>
                      Treinamento operacional quando necessário, mediante solicitação e
                      programação;
                    </li>
                    <li>
                    ...
                    <li>
                      Visitas corretivas adicionais ou avulsas serão taxas de acordo com
                      o informado na proposta comercial;{" "}
                    </li>
                    <li>
                      Reunião de gestão bimestral online, para discussão e análise de
                      necessidades geradas pelas estratégias do negócio do cliente, para
                      que o TI possa dar suporte às outras áreas funcionais do negócio;{" "}
                    </li>
                    <li>
                      Atendimento remoto ou telefônico, para suporte técnico a usuários
                      conforme indicado na proposta comercial;{" "}
                    </li>
                    <li>
                      ...
                      primeira hora e R$95,00 (noventa e cinco reais) por hora adicional
                      trabalhada, somado o custo de deslocamento.
                    </li>
                    <li>
                      Para chamados de manutenção remota, atendidos de segunda a sexta
                      após as 18h00 e sabado das 09h00 às 18h00, será taxado em R$35,00
                      (trinta e cinco reais) por hora trabalhada.{" "}
                    </li>
                    <li>
                      Para chamados de manutenção remota atendidos aos sabados após as
                      18h00,domingos e feriados, será taxado em R$70,00 (setenta reais)
                      por hora trabalhada.{" "}
                    </li>
                    <li>
            ...
            <div className={styles.view}>
              <ul>
                ...
                <li>
                  ...
                  contratante poderá solicitar a reposição temporária do equipamento
                  através de locação do item. A Contratada deverá encaminhar
                  previamente o orçamento ou tabela de locação à contratante que
                  decidirá sobre a proposta;{" "}
                </li>
                <li>
            ...
            <div className={styles.view}>
              <ul>
                <li>
                  ...
                  Transferência do contrato à terceiros sem a prévia concordância
                  das partes. E caso ocorra a necessidade de transferência de
                  contrato à terceiros, a Contratante deve informar por escrito, com
                  60 (sessenta) dias de antecedência a Contratada, aﬁm de manter os
            ...
            <p className={styles.view}>
              ...
              impostos será realizada no ato do faturamento e quaisquer alterações
              de alíquotas ou novos tributos, impostos ou taxas que venham a ser
              criadas, incidentes sobre os serviços objetivo deste contrato,
              constituirão encargos do Contratante e calculados sobre os preços
              então vigentes. Este item será objeto de renegociação, no caso de
            ...
            <p className={styles.view}>
              ...
              inﬂação ocorrida no período ou, ainda, por qualquer outro determinado
              pelo Governo Federal, a ﬁm de manter o equilíbrio econômico e
              ﬁnanceiro desta prestação de serviços.
            </p>
            <p className={styles.view}>
              ...
              contratada para que seja incorporado ao presente contrato, assim como
              reajustado o valor do contrato nos itens contratados por usuário ou
              dispositivo conform tabela de deﬁnição de investimento.
            </p>
